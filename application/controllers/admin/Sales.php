...
class Sales extends CI_Controller {
	...
	public function index()
	{
		...
		$data['sales'] = $this->sales_model->tampil_data()->result();
	...
	public function input(){
		...
		$this->load->view('admin/form_sales', $data);
		$this->load->view('templates_admin/footer');
	...
	public function input_aksi(){
		...
		if ($this->form_validation->run() == FALSE) {
            ...
            $cek_id_sales = $this->sales_model->cekIdSales($idSales);
            if ($cek_id_sales > 0) {
                $this->input();
    ...
    public function update($id){
    	...
    	$data['sales'] = $this->sales_model->edit_data($where,'master_sales')->result();

    	$data['agency'] = $this->agency_model->get_data('agency')->result();
		$this->load->view('templates_admin/header');
		$this->load->view('templates_admin/sidebar');
		$this->load->view('admin/update_sales', $data);
		$this->load->view('templates_admin/footer');
    }
    ...
    public function update_aksi(){
    	...
    	$this->sales_model->update_data($where, $data, 'master_sales');
    	$this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    public function delete($id){
    	...
    	$where = array('id_sales' => $id);
    	$this->sales_model->hapus_data($where,'master_sales');
    	$this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-dismissible fade show" role="alert">
